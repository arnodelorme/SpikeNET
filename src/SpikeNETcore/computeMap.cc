	...
	{																																																		\
		...
		{																																																	\
			...
			{																																																\
	    		...
	    		activite[tmp_neur] = *(state[l]+tmp_neur);																																								\
 		    	for (l = map_SpikeInputs.nb_groups-1; l >= 0; l--) *(state[l]+tmp_neur) =  0; /* WARNING BUG IF THIS TERM -map_SpikeInputs.relevant_afferences[l] +*(state[l]+tmp_neur);*/ /*-map_SpikeInputs.relevant_afferences[l]; //considere le total*/															\
